...
function Contact() {
  return (
    <div className='border border-t-[#33353F] border-l-transparent border-r-transparent'>
      <h1 className='text-white text-center text-4xl font-extrabold py-5'>Contact Me</h1>
      <div className="grid md:grid-cols-2 my-12 md:my-12 gap-4 relative">
        <div className="z-10">
          ...
          <div className="socials flex flex-row gap-2">
            <Link href="http://www.github.com/farooque1" target='_blank'>
            ...
            <Link href="https://www.linkedin.com/in/mohammed-farooque-shaikh-4675ba168/" target='_blank'>
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 64 64">
